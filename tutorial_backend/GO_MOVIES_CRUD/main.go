...
func createMovie(w http.ResponseWriter, r *http.Request) {
	...
	movie.ID = strconv.Itoa(rand.Intn(10000000)) // Generate a random ID
...
func main() {
	...
	movies = append(movies, Movie{ID: "2", Isbn: "3214321", Title: "Movie Two", Director: &Director{Firstname: "Steve", Lastname: "Smith"}})
